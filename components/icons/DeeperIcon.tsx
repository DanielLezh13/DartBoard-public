// components/icons/DeeperIcon.tsx
import * as React from "react";

export interface DeeperIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
}

export function DeeperIcon({ size = 26, className, ...rest }: DeeperIconProps) {
  ...
  return (
    ...
    >
      ...
      <path
        d="M379.327,337.307l-25.658-68.74V161.591h-0.001c-0.031-2.378-1.189-4.6-3.119-5.988L181.353,33.878
