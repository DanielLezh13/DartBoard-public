...
interface MemoryPanelContextProps {
  memories: Memory[];
  selectedMemoryId: number | null;
  searchQuery: string;
  selectedFolder: string | null;
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 h-full min-h-0 w-64 flex flex-col" style={{ touchAction: "pan-y" }}>
        {/* Header - Memories bar (matches SessionListPane style) */}
        <div className="flex flex-col flex-shrink-0 border-b border-gray-700/30">
          ...
          {/* Active folder info (mirrors SessionListPane "Active chat") */}
          <div
            className={
        ...
        {/* Search memories (matches SessionListPane search chats) */}
