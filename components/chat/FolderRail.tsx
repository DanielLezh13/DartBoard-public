...
export type Folder = {
  id: number
  name: string
  // Optional display overrides (initially handled locally in FolderRail)
...
export function FolderRail({
  ...
  // IMPORTANT: Mirror RightRail behavior to avoid "false new-folder" animation
      ...
      <div className="flex-1 min-h-0 w-full flex flex-col overflow-hidden">
        ...
        >
          ...
          <div className="w-full flex flex-col items-center gap-2 pt-1 pb-2">
            ...
            {/* + bubble as the last item in the scroll stack (mirrors RightRail) */}
            {!atFolderLimit && (
