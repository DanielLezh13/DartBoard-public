...
import { MemoryFolderRail, type MemoryFolder } from "./MemoryFolderRail";

const MEMORY_DOCK_W_OPEN = 329; // MEMORY_PANEL_W (256) + divider (1) + MEMORY_FOLDER_RAIL_W (72) = 329

type MemoryDockProps = {
  open: boolean;
  /**
...
export function MemoryDock({
  ...
  onToggle: _onToggle,
  onToggleMemoryDock: _onToggleMemoryDock,
  memoryPanelOpen: _memoryPanelOpen,
  ...
  return (
    <div
      ...
      style={{
        width: MEMORY_DOCK_W_OPEN,
      }}
    >
      <div className="h-full min-h-0 flex relative min-w-0">
        {/* MemoryPanel (left side of dock, slides in/out) */}
        <MemoryPanel
        ...
        {/* MemoryFolderRail (right side of dock, always visible at edge) */}
        <MemoryFolderRail
          folders={folders}
          selectedFolder={selectedFolder}
          onFolderSelect={onFolderSelect}
