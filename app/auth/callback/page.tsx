...
function AuthCallbackInner() {
  ...
  useEffect(() => {
    const handleCallback = async () => {
      ...
      devLog('[CLIENT CALLBACK] Processing callback', { hasCode: !!code, next })
      ...
      try {
        ...
        if (!error && session) {
          devLog('[CLIENT CALLBACK] Got session, syncing to server...')
          try {
          ...
          devLog('[CLIENT CALLBACK] No session after callback', { hasError: !!error })
        }
      } catch (e) {
