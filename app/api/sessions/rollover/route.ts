...
Generate the digest now:`;
      ...
      devLog('[ROLLOVER] Generated Session Digest with', sampledMessages.length, 'main messages +', tailBlock.length, 'tail messages');
    ...
    try {
      ...
      devLog("[ROLLOVER FINAL TOUCH] Updated session with latest MRU:", {
        newSessionId,
    ...
    devLog("[ROLLOVER DEBUG] Created new session:", {
      newSessionId,
      mru_ts: finalMruTs,
